...
//	 传入签名参数
public BosSign(String requestMethod, String host, String uri,int expiresInSeconds, String queryString) {
		super();
...
//		System.out.println("CanonicalRequest: "+CanonicalRequest);
		...
		String signKeyInfo = "bce-auth-v1" + "/e03dff1a5d7049c5ab40650b655885b9/" + timestamp+ "/" + expiresInSeconds;
//		System.out.println("signKeyInfo: "+signKeyInfo);
		
		//将signKeyInfo与SK加密生成signingKey
		String signingKey = sha256Hex("f299118b5e7d474f84badea389c8d17d", signKeyInfo);
//		System.out.println("signingKey: "+signingKey);
		...
		String authorization = joinN("/", new String[] { "bce-auth-v1","e03dff1a5d7049c5ab40650b655885b9", timestamp, String.valueOf(expiresInSeconds), "host",signature });
